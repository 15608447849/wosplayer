...
public class ToolsUtils {
    ...
    {
        String value= readShareData(PlayApplication.appContext,key).trim();
    ...
    public static String getAppVersionName() {
        String versionName = "";
        try {
            PackageManager pm = PlayApplication.appContext.getPackageManager();
            PackageInfo pi = pm.getPackageInfo(PlayApplication.appContext.getPackageName(), 0);
